...
export function renderAdmin({ packages, openIds, onChange }) {
  ...
  admin.innerHTML = `
    ...
    <div class="admin-help">
      <h3>Resultaten van leerlingen</h3>
      <p>Leerlingen vullen eerst hun naam in. Resultaten worden op hun toestel bewaard.</p>
      <p>Wil je als leerkracht alle resultaten centraal zien, koppel dan een Google Sheet via Apps Script. Vul daarna de webapp link in bij <code>data/settings.json</code> achter <code>resultEndpoint</code>.</p>
    </div>
  `;
